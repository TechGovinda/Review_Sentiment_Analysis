...
MLFLOW_TRACKING_URI = "https://dagshub.com/TechGovinda/Review_Sentiment_Analysis.mlflow"
dagshub.init(
    repo_owner="TechGovinda", repo_name="Review_Sentiment_Analysis", mlflow=True
)
...
def train_and_log_model(X_train, X_test, y_train, y_test, vectorizer):
    """Trains a logistic Regression model with GridSearch and logs result to mlflow"""
    param_grid = {
        "C": [0.1, 1, 10, 100],
        "penalty": ["l1", "l2"],
        "solver": ["liblinear"],
    ...
    with mlflow.start_run():
        ...
        # Log all hyperparameters tuninf runs
        ...
        print(f"\nBest params:{best_params} |Best_F1_Score: {best_f1:0.4f}")
